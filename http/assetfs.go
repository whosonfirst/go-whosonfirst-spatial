...
var _bindata = map[string]func() (*asset, error){
	"static/javascript/mapzen.whosonfirst.pip.js": staticJavascriptMapzenWhosonfirstPipJs,
	"static/javascript/slippymap.crosshairs.js": staticJavascriptSlippymapCrosshairsJs,
	"static/css/mapzen.whosonfirst.pip.css": staticCssMapzenWhosonfirstPipCss,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"static": &bintree{nil, map[string]*bintree{
		"css": &bintree{nil, map[string]*bintree{
			"mapzen.whosonfirst.pip.css": &bintree{staticCssMapzenWhosonfirstPipCss, map[string]*bintree{}},
		}},
		"javascript": &bintree{nil, map[string]*bintree{
			"mapzen.whosonfirst.pip.js": &bintree{staticJavascriptMapzenWhosonfirstPipJs, map[string]*bintree{}},
